...
class ChatbotScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('بُعد', style: TextStyle(color: Colors.black)),
                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                      ...
                      child: Row(children: [
                        ...
                        ChipButton(text: "ما معنى بُعد "),
                        ChipButton(text: "اريد التدرب على مشهد حزين "),
                        ChipButton(text: "اريد التدرب على مشهد غضب "),
                        ChipButton(text: "اريد التدرب على مشهد فرح "),
                      ])),
                ),
              ),
